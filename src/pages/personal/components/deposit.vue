      ...
      <div class="deposit-zone">
        <ul class="depositWay">
          <li v-for="(item,index) in navList" :class = "{active:!(index-menuIndex)}" @click = 'menuShow(index)'>
            ...
            <a href="#">{{item}}</a><span class="cross-line">|</span></li>
        </ul>
      </div>
      <div class="depositWay-content">
        <!--快捷支付-->
        <div class="kj"  v-show = 'menuIndex == 0'>
        <div class="step">
        ...
        <div class="way">
          <img class="bankCard" src="https://line.txwl-888.com/group1/M00/00/2E/DsBDFV5LTK2AeX7BAAAKhUdmA1k245.png"/>
          <span class="tex">支付1</span>
        </div>
        <div class="amount-box">
          <div class="amount-deposited">
            <label>存款金额 ：</label>
            <input type="number" class="Distribute"/>
            <div class="ts">单笔限额20-50000(元)</div>
        ...
        <!--天下尊享支付-->
        <div class="tx"  v-show = 'menuIndex == 1'>
          <div class="tx-top">
        ...
        <!--&lt;!&ndash;支付宝支付&ndash;&gt;-->
        <div class="treasure"  v-show = 'menuIndex == 2'>
        ...
        <!--&lt;!&ndash;云支付&ndash;&gt;-->
        <div class="treasure"  v-show = 'menuIndex == 3'>
          <div class="treasure-ways">
            <div class="step">
              <el-steps :active="active" finish-status="success">
                <el-step title="输入金额"></el-step>
            ...
            <div class="zfb-way-box">
              <div class="zfb-way zfb-way-active">
                <img src="https://line.txwl-888.com/group1/M00/00/2F/ZxcuGF5LTpSAE8irAAAJOek1zow633.png">
                <span>支付1</span>
              </div>
          ...
          <div class="treasure-amount">
            <div class="amount-treasure">
              <label>存款金额 ：</label>
              <input type="number" class="Distribute"/>
              <div class="ts">单笔限额200-5000(元)</div>
              <el-button class="btn-next" @click="next">下一步</el-button>
            </div>
        ...
        <!--&lt;!&ndash;比特币支付 &ndash;&gt;-->
        <div class="treasure"  v-show = 'menuIndex == 4'>
          <div class="treasure-ways">
            <div class="step">
              <el-steps :active="active" finish-status="success">
                <el-step title="输入金额"></el-step>
            ...
            <div class="zfb-way-box">
              <div class="zfb-way zfb-way-active">
                <img src="https://line.txwl-888.com/group1/M00/00/2F/ZxcuGF5LTqiAUiUzAAAKZqW6gnA420.png">
                <span>支付1</span>
              </div>
            </div>
          </div>
        ...
        <!--网银-->
        <div class="treasure"  v-show = 'menuIndex == 5'>
          <div class="treasure-ways">
            <div class="step">
              <el-steps :active="active" finish-status="success">
                <el-step title="输入金额"></el-step>
        ...
        <!--银联卡-->
        <div class="treasure"  v-show = 'menuIndex == 6'>
          <div class="treasure-ways">
            <div class="step">
              <el-steps :active="active" finish-status="success">
                <el-step title="输入金额"></el-step>
  ...
  export default {
    ...
    data() {
      return {
        active: 1,
        menuIndex: 0,
        navList: ['快捷支付', '天下尊享支付', '支付宝支付', '云支付', '比特币支付', '网银支付', '银联支付'],
        navImg: [
          {
            id: '0001',
            name: '快捷支付',
            imgUrl: 'https://line.txwl-888.com/group1/M00/00/2E/DsBDFV5LTK2AeX7BAAAKhUdmA1k245.png'
          }, {
            id: '0002',
            name: '天下尊享支付',
            imgUrl: 'https://line.jzs001.cn/group1/M00/00/7A/Z_QBx18Bp_SAE4gGAAADmClhtIo177.jpg'
          }, {
            id: '0003',
            name: '支付宝支付',
            imgUrl: 'https://line.txwl-888.com/group1/M00/00/2F/ZxcuGF5Ki0aADrqAAAAJTOT7d78069.png'
          }, {
            id: '0004',
            name: '云支付',
            imgUrl: 'https://line.txwl-888.com/group1/M00/00/2F/ZxcuGF5LTpSAE8irAAAJOek1zow633.png'
          }, {
            id: '0005',
            name: '比特币支付',
            imgUrl: 'https://line.txwl-888.com/group1/M00/00/2F/ZxcuGF5LTqiAUiUzAAAKZqW6gnA420.png'
          }, {
            id: '0006',
            name: '网银支付',
            imgUrl: 'https://line.txwl-888.com/group1/M00/00/2F/ZxcuGF5LTjKAJxjFAAAIdpzEHY4254.png'
          }, {
            id: '0007',
            name: '银联支付',
            imgUrl: 'https://line.txwl-888.com/group1/M00/00/2F/ZxcuGF5LTcqAWnY_AAAKw3rnSTE651.png'
          },]
      }
    },
