        ...
        <div class="content">
            <div class="electronic-">
                <div class="electronic-nav">
                    <el-tabs v-model="activeName" class="electronic-box" @tab-click="changeGameType">
                        <el-tab-pane
                            ...
                            :name="item.gameCode"
                        >
                            <span slot="label"><img class="ele-icon"
                                                    :src="item.icons[0].href"/> {{ item.menuNameCn }}</span>
    ...
    methods: {
            ...
            this.axios.get('api/menu', {params: {terminal: 0}})
                .then((response) => {
                    ...
                    if (resbody.status === 10000) {
                        ...
                        this.activeName = this.currentGameType;
        ...
        getGame () {
            this.axios.get('/api/game/list', {
                ...
                this.currentGameClass = response.data.list;
        ...
        changeGameType (tab, event) {
            this.currentGameType = this.subGameTitle[tab.index].gameCode;
            this.currentPage = 1;
            this.getGame();
        },
        switchItem (index) {
